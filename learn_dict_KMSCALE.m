function [conf] = learn_dict_KMSCALE(conf, hires, dictsize)
...
idx_rand = randperm(size(plores, 2));
idx_train = idx_rand(1:5e5);
plores_train = plores(:, idx_train);
data_to_train_cluster = plores_train';
