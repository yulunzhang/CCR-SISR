...
input_dir = 'Set91'; % Directory with input images from Set5 image dataset
...
%         'NE+LS','NE+NNLS','NE+LLE','Our A+ (0.5mil)','Our A+', 'Our A+ (16atoms)'};
    conf.desc = {'Gnd', 'Bicubic', 'Yang', 'Zeyde', 'GR', 'ANR', 'NE_LS','NE_NNLS','NE_LLE','Aplus05mil','Aplus', 'Aplus16atoms'};
    conf.results = {};
