function [conf] = learn_dict_T1(conf, hires, dictsize)
...
ksvd_conf.Tdata = 1; % maximal sparsity: TBD
...
[conf.dict_lores_T1, gamma] = ksvd(ksvd_conf); 
conf.dict_lores = conf.dict_lores_T1;
toc;
...
conf.dict_hires_T1 = double(dict_hires); 
conf.dict_hires = conf.dict_hires_T1;
end